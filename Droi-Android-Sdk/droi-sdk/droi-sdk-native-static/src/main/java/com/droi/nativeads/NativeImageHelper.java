...
import com.droi.nativeads.CustomEventNative.CustomEventNativeListener;
    ...
    public static void preCacheImages(@NonNull final Context context,
        ...
        ImageLoader.ImageListener volleyImageListener = new ImageLoader.ImageListener() {
            ...
            public void onErrorResponse(final VolleyError volleyError) {
                DroiLog.d("Failed to download a native ads image:", volleyError);
    ...
    public static void loadImageView(@Nullable final String url, @Nullable final ImageView imageView) {
        ...
        mImageLoader.get(url, new ImageLoader.ImageListener() {
            ...
            public void onResponse(final ImageLoader.ImageContainer imageContainer,
                ...
                if (!isImmediate) {
                    DroiLog.d("Image was not loaded immediately into your ad view. You should call preCacheImages as part of your custom event loading process.");
                }
            ...
            @Override
            public void onErrorResponse(final VolleyError volleyError) {
                DroiLog.d("Failed to load image.", volleyError);
                imageView.setImageDrawable(null);
            }
        });
    }
