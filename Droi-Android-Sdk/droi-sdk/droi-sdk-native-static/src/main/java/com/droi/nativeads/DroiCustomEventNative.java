...
import com.droi.nativeads.NativeImageHelper.ImageListener;
...
import static com.droi.common.DataKeys.JSON_BODY_KEY;
import static com.droi.common.util.Numbers.parseDouble;
import static com.droi.nativeads.NativeImageHelper.preCacheImages;

public class DroiCustomEventNative extends CustomEventNative {
    ...
    protected void loadNativeAd(@NonNull final Context context,
        ...
        final DroiStaticNativeAd mDroiStaticNativeAd =
                new DroiStaticNativeAd(context,
                        (JSONObject) json,
        ...
        try {
            mDroiStaticNativeAd.loadAd();
        } catch (IllegalArgumentException e) {
            customEventNativeListener.onNativeAdFailed(NativeErrorCode.UNSPECIFIED);
        }
    }

    static class DroiStaticNativeAd extends StaticNativeAd {
        enum Parameter {
        ...
        @VisibleForTesting
        static final String PRIVACY_INFORMATION_CLICKTHROUGH_URL = "https://www.droi.com/optout";
        ...
        DroiStaticNativeAd(@NonNull final Context context,
        ...
        void loadAd() throws IllegalArgumentException {
            ...
            preCacheImages(mContext, getAllImageUrls(), new ImageListener() {
                ...
                public void onImagesCached() {
                    mCustomEventNativeListener.onNativeAdLoaded(DroiStaticNativeAd.this);
                }
            ...
            try {
                switch (key) {
                    ...
                    case STAR_RATING:
                        ...
                        break;
                    default:
                        DroiLog.d("Unable to add JSON key to internal mapping: " + key.name);
                        break;
                }
            } catch (ClassCastException e) {
                if (!key.required) {
                    DroiLog.d("Ignoring class cast exception for optional key: " + key.name);
                } else {
                    throw e;
                }
            }
