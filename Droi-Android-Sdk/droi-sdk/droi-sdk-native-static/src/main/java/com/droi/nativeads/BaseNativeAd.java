 ...
 * native ad format, be sure to also implement and register an appropriate {@link DroiAdRenderer}
...
public abstract class BaseNativeAd {
     ...
     * Droi impression trackers to fire correctly.
     */
     ...
     * Droi click trackers to fire correctly.
     */
    ...
    final protected void addImpressionTrackers(final Object impressionTrackers) throws ClassCastException {
        ...
        for (int i = 0; i < trackers.length(); i++) {
            try {
                ...
                DroiLog.d("Unable to parse impression trackers.");
            }
        }
    }
    ...
    final protected void addClickTrackers(final Object clickTrackers) throws ClassCastException {
        ...
        for (int i = 0; i < trackers.length(); i++) {
            try {
                ...
                // This will only occur if we access a non-existent index in JSONArray.
                DroiLog.d("Unable to parse click trackers.");
            }
        }
    }
