...
/**
 * A data that represents placed ads in a {@link com.droi.nativeads.DroiStreamAdPlacer},
...
class PlacementData {
    ...
    @NonNull
    static PlacementData fromAdPositioning(@NonNull final DroiClientPositioning adPositioning) {
        final List<Integer> fixed = adPositioning.getFixedPositions();
        final int interval = adPositioning.getRepeatingInterval();

        final int size = (interval == DroiClientPositioning.NO_REPEAT ? fixed.size() : MAX_ADS);
    ...
    void placeAd(final int adjustedPosition, final NativeAd nativeAd) {
        ...
        if (desiredIndex == mDesiredCount
            ...
            DroiLog.w("Attempted to insert an ad at an invalid position");
            return;
        }
    ...
    /**
     * @see {@link com.droi.nativeads.DroiStreamAdPlacer#isAd(int)}
     */
    ...
    /**
     * @see com.droi.nativeads.DroiStreamAdPlacer#getOriginalPosition(int)
     */
    ...
    /**
     * @see com.droi.nativeads.DroiStreamAdPlacer#getAdjustedPosition(int)
     */
    ...
    /**
     * @see com.droi.nativeads.DroiStreamAdPlacer#getOriginalCount(int)
     */
    ...
    /**
     * @see com.droi.nativeads.DroiStreamAdPlacer#getAdjustedCount(int)
     */
    ...
    /**
     * @see com.droi.nativeads.DroiStreamAdPlacer#insertItem(int)
     */
    ...
    /**
     * @see com.droi.nativeads.DroiStreamAdPlacer#removeItem(int)
     */
    ...
    /**
     * @see com.droi.nativeads.DroiStreamAdPlacer#moveItem(int, int)
     */
