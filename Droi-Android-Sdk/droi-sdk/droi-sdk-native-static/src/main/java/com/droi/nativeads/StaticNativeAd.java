...
public abstract class StaticNativeAd extends BaseNativeAd implements ImpressionInterface, ClickInterface {
     ...
     * with Droi's direct-sold native ads or from mediated networks that pass back additional
     * fields.
     */
    @NonNull
    ...
    final public void setStarRating(@Nullable final Double starRating) {
        if (starRating == null) {
            ...
            DroiLog.d("Ignoring attempt to set invalid star rating (" + starRating + "). Must be "
