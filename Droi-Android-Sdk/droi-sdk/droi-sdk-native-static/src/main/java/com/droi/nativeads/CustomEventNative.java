 ...
 * implementing subclasses of {@code CustomEventNative}, you can enable the Droi SDK to support a
 * wider variety of third-party ad networks, or execute any of your application code on demand.
 *
 * At runtime, the Droi SDK will find and instantiate a {@code CustomEventNative} subclass as
 * needed and invoke its {@link #loadNativeAd} method.
 */
public abstract class CustomEventNative {
    /**
     * When the Droi SDK receives a response indicating it should load a custom event, it will send
     ...
     * application by calling {@link DroiNative#setLocalExtras(Map)}. Note that the
     * localExtras Map is a copy of the Map supplied to {@link DroiNative#setLocalExtras(Map)}.
     * @param serverExtras A Map containing additional custom data configurable on the Droi website
