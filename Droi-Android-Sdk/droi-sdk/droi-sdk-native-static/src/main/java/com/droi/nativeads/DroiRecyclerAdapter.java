...
import static com.droi.nativeads.DroiRecyclerAdapter.ContentChangeStrategy.INSERT_AT_END;
import static com.droi.nativeads.DroiRecyclerAdapter.ContentChangeStrategy.KEEP_ADS_FIXED;


public final class DroiRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public DroiRecyclerAdapter(@NonNull Activity activity,
    ...
    public DroiRecyclerAdapter(@NonNull Activity activity,
                               @NonNull RecyclerView.Adapter originalAdapter,
                               @NonNull DroiServerPositioning adPositioning) {
    ...
    public DroiRecyclerAdapter(@NonNull Activity activity,
                               @NonNull RecyclerView.Adapter originalAdapter,
                               @NonNull DroiClientPositioning adPositioning) {
        this(new DroiStreamAdPlacer(activity, adPositioning), originalAdapter,
                new VisibilityTracker(activity));
    }

    @VisibleForTesting
    DroiRecyclerAdapter(@NonNull final DroiStreamAdPlacer streamAdPlacer,
     ...
     */
    public void registerAdRenderer(@NonNull DroiAdRenderer adRenderer) {
    ...
    public void refreshAds(@NonNull String adUnitId,
        ...
        if (mRecyclerView == null) {
            DroiLog.w("This adapter is not attached to a RecyclerView and cannot be refreshed.");
            return;
        }

        final RecyclerView.LayoutManager layoutManager = mRecyclerView.getLayoutManager();
        if (layoutManager == null) {
            DroiLog.w("Can't refresh ads when there is no layout manager on a RecyclerView.");
            return;
        }
        ...
        if (layoutManager instanceof LinearLayoutManager) {
            ...
            DroiLog.w("This LayoutManager can't be refreshed.");
            return;
        }
    }
     ...
     * are cleared, {@link DroiNativeAdLoadedListener#onAdRemoved} will be called for each ad
     ...
     * <ul>
     * <li>{@link com.droi.nativeads.DroiRecyclerAdapter.ContentChangeStrategy#INSERT_AT_END}
     ...
     * <li>{@link com.droi.nativeads.DroiRecyclerAdapter.ContentChangeStrategy#MOVE_ALL_ADS_WITH_CONTENT}
     ...
     * <li>{@link com.droi.nativeads.DroiRecyclerAdapter.ContentChangeStrategy#KEEP_ADS_FIXED}
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(final ViewGroup parent, final int viewType) {
        if (viewType >= NATIVE_AD_VIEW_TYPE_BASE && viewType <= NATIVE_AD_VIEW_TYPE_BASE + mStreamAdPlacer.getAdViewTypeCount()) {
            ...
            final DroiAdRenderer adRenderer = mStreamAdPlacer.getAdRendererForViewType(viewType - NATIVE_AD_VIEW_TYPE_BASE);
            if (adRenderer == null) {
                DroiLog.w("No view binder was registered for ads in DroiRecyclerAdapter.");
                // This will cause a null pointer exception.
                return null;
            }
            return new DroiRecyclerViewHolder(
    ...
    public int getItemViewType(final int position) {
        ...
        if (type != DroiStreamAdPlacer.CONTENT_VIEW_TYPE) {
    ...
    public boolean onFailedToRecycleView(final RecyclerView.ViewHolder holder) {
        if (holder instanceof DroiRecyclerViewHolder) {
