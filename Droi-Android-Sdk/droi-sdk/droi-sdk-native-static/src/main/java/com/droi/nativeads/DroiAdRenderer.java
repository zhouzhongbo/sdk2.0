 ...
 *
 * Normally you will use the subclass {@link DroiStaticNativeAdRenderer} with {@link
 * com.droi.nativeads.ViewBinder} to customize your ad view with your own layout. However, if you
 * wish to programmatically create or manage your ad view, you can implement {@code DroiAdRenderer}
 * directly.
 *
 * @param <T> The ad payload type.
 */
public interface DroiAdRenderer<T extends BaseNativeAd> {
    /**
     * Creates a new view to be used as an ad.
     * <p/>
     * This method is called when you call {@link com.droi.nativeads.DroiStreamAdPlacer#getAdView}
