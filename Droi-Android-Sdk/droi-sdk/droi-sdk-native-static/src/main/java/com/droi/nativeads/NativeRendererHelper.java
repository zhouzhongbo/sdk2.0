...
import com.droi.common.util.Drawables;
...
public class NativeRendererHelper {
    public static void addTextView(@Nullable final TextView textView,
        ...
        if (textView == null) {
            DroiLog.d("Attempted to add text (" + contents + ") to null TextView.");
            return;
        }
        ...
        if (contents == null) {
            DroiLog.d("Attempted to set TextView contents to null.");
        } else {
     ...
     * @param privacyInformationImageUrl        The image url. If this is null, the default Droi
     *                                          icon is used.
    ...
    public static void updateExtras(@Nullable final View mainView,
        ...
        if (mainView == null) {
            DroiLog.w("Attempted to bind extras on a null main view.");
            return;
        }
        ...
        for (final String key : extrasIds.keySet()) {
            ...
            if (view instanceof ImageView) {
                ...
                DroiLog.d("View bound to " + key + " should be an instance of TextView or ImageView.");
            }
        }
    }
}
