...
import com.droi.network.ScribeBackoffPolicy;
import com.droi.network.ScribeRequest;
import com.droi.network.ScribeRequestManager;
...
public class ScribeEventRecorder implements EventRecorder {
    private static final String SCRIBE_URL = "https://analytics.droi.com/i/jot/exchange_client_event";
    ...
    public void record(@NonNull BaseEvent baseEvent) {
        ...
        if (mEventQueue.size() >= QUEUE_MAX_SIZE) {
            DroiLog.d("EventQueue is at max capacity. " +
