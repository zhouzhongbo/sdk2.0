...
import com.droi.common.factories.MethodBuilderFactory;
...
import static com.droi.common.util.Reflection.classFound;
...
public class GpsHelper {
    ...
    static public AdvertisingInfo fetchAdvertisingInfoSync(final Context context) {
        ...
        try {
            ...
            DroiLog.d("Unable to obtain Google AdvertisingIdClient.Info via reflection.");
            return null;
        }
    ...
    static private void internalFetchAdvertisingInfoAsync(final Context context, final GpsHelperListener gpsHelperListener) {
        ...
        try {
            ...
            DroiLog.d("Error executing FetchAdvertisingInfoTask", exception);
