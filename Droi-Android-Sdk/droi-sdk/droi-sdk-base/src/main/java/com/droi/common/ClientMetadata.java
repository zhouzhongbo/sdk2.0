...
public class ClientMetadata {
    ...
    public enum DroiNetworkType {
        ...
        private static DroiNetworkType fromAndroidNetworkType(int type) {
            switch(type) {
                case TYPE_ETHERNET:
                    return ETHERNET;
    ...
    private static String getAppVersionFromContext(Context context) {
        try {
            ...
            DroiLog.d("Failed to retrieve PackageInfo#versionName.");
            return null;
        }
    }
    ...
    public DroiNetworkType getActiveNetworkType() {
        ...
        return DroiNetworkType.fromAndroidNetworkType(networkType);
    }
