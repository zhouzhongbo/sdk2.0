 ...
 */
public class DroiLifecycleManager implements LifecycleListener {
    private static com.droi.common.DroiLifecycleManager sInstance;
    ...
    private DroiLifecycleManager(Activity mainActivity) {
        mLifecycleListeners = new HashSet<LifecycleListener>();
        mMainActivity = new WeakReference<Activity>(mainActivity);
    }

    @NonNull public static synchronized com.droi.common.DroiLifecycleManager getInstance(Activity mainActivity) {
        if (sInstance == null) {
            sInstance = new com.droi.common.DroiLifecycleManager(mainActivity);
        }
