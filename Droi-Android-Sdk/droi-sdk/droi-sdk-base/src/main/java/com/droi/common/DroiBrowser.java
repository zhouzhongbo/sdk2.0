...
import static com.droi.common.event.BaseEvent.*;
import static com.droi.common.util.Drawables.BACKGROUND;
import static com.droi.common.util.Drawables.CLOSE;
import static com.droi.common.util.Drawables.LEFT_ARROW;
import static com.droi.common.util.Drawables.REFRESH;
import static com.droi.common.util.Drawables.RIGHT_ARROW;

public class DroiBrowser extends Activity {
    public static final String DESTINATION_URL_KEY = "URL";
    public static final String DSP_CREATIVE_ID = "droi-dsp-creative-id";
    public static final int DROI_BROWSER_REQUEST_CODE = 1;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(getDroiBrowserView());
    ...
    protected void onDestroy() {
        ...
        DroiEvents.log(new Event.Builder(Name.AD_DWELL_TIME,
    ...
    private View getDroiBrowserView() {
        LinearLayout mDroiBrowserView = new LinearLayout(this);
        LinearLayout.LayoutParams browserLayoutParams = new LinearLayout.LayoutParams(MATCH_PARENT, MATCH_PARENT);
        mDroiBrowserView.setLayoutParams(browserLayoutParams);
        mDroiBrowserView.setOrientation(LinearLayout.VERTICAL);
        ...
        mDroiBrowserView.addView(outerLayout);
