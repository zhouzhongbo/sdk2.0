package com.droi.common.logging;
...
public class DroiLog {
    public static final String LOGGER_NAMESPACE = "com.droi";

    private static final String LOGTAG = "Droi";
    private static final Logger LOGGER = Logger.getLogger(LOGGER_NAMESPACE);
    private static final DroiLogHandler LOG_HANDLER = new DroiLogHandler();
    ...
    public static void c(final String message) {
        DroiLog.c(message, null);
    }

    public static void v(final String message) {
        DroiLog.v(message, null);
    }

    public static void d(final String message) {
        DroiLog.d(message, null);
    }

    public static void i(final String message) {
        DroiLog.i(message, null);
    }

    public static void w(final String message) {
        DroiLog.w(message, null);
    }

    public static void e(final String message) {
        DroiLog.e(message, null);
    }
    ...
    private static final class DroiLogHandler extends Handler {
