...
import static com.droi.common.util.VersionCode.HONEYCOMB;
...
public class DeviceUtils {
    ...
    public static int memoryCacheSizeBytes(final Context context) {
        ...
        if (currentApiLevel().isAtLeast(HONEYCOMB)) {
            try {
                ...
                DroiLog.d("Unable to reflectively determine large heap size on Honeycomb and above.");
            }
        }
    ...
    public static long diskCacheSizeBytes(File dir, long minSize) {
        ...
        try {
            ...
            DroiLog.d("Unable to calculate 2% of available disk space, defaulting to minimum");
        }
    ...
    static int getScreenOrientationFromRotationAndOrientation(int rotation, int orientation) {
        if (Configuration.ORIENTATION_PORTRAIT == orientation) {
            ...
            DroiLog.d("Unknown screen orientation. Defaulting to portrait.");
            return ActivityInfo.SCREEN_ORIENTATION_REVERSE_PORTRAIT;
        }
    }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB_MR2) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
                ...
                try {
                    ...
                    DroiLog.v("Display#getRawWidth/Height failed.", e);
                }
            }
        }
