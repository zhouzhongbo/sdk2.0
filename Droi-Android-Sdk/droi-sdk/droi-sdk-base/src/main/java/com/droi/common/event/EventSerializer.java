...
public class EventSerializer {
    ...
    public JSONArray serializeAsJson(@NonNull List<BaseEvent> events) {
        ...
        for (BaseEvent event : events) {
            try {
                ...
                DroiLog.d("Failed to serialize event \"" + event.getName() + "\" to JSON: ", e);
            }
        }
        return jsonArray;
    }
    ...
    public JSONObject serializeAsJson(@NonNull BaseEvent event) throws JSONException {
        ...
        // Network Details
        ClientMetadata.DroiNetworkType mDroiNetworkType = event.getNetworkType();
        jsonObject.put("network_type", mDroiNetworkType == null ? null : mDroiNetworkType.getId());
