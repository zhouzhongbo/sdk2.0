...
public class Event extends BaseEvent {
     ...
     *
     * @param name         Event name: See {@link com.droi.common.event.BaseEvent.Name} for
     *                     constants.
     * @param category     Category: See {@link com.droi.common.event.BaseEvent.Category} for
     *                     constants.
     * @param samplingRate The percentage of events to sample. See {@link com.droi.common.event.BaseEvent.SamplingRate}
     *                     for constants.
    ...
    public static BaseEvent createEventFromDetails(@NonNull final BaseEvent.Name name,
        ...
        if (eventDetails == null) {
            DroiLog.d("Unable to log event due to no details present");
            return null;
        }
