...
import static com.droi.common.util.VersionCode.HONEYCOMB_MR2;
import static com.droi.common.util.VersionCode.currentApiLevel;

public class ManifestUtils {
    private ManifestUtils() {}

    private static final String DROI_ACTIVITY = "com.droi.mobileads.DroiActivity";
    private static final String MRAID_ACTIVITY = "com.droi.mobileads.MraidActivity";
    ...
    static {
        ...
        // As a convenience, full class paths are provided here, in case the Droi SDK was imported
        // incorrectly and these files were left out.
        try {
            final Class mDroiActivityClass = Class.forName(DROI_ACTIVITY);
            final Class mraidActivityClass = Class.forName(MRAID_ACTIVITY);
            REQUIRED_WEB_VIEW_SDK_ACTIVITIES.add(mDroiActivityClass);
            REQUIRED_WEB_VIEW_SDK_ACTIVITIES.add(mraidActivityClass);
        } catch (ClassNotFoundException e) {
            DroiLog.i("ManifestUtils running without interstitial module");
        }

        REQUIRED_WEB_VIEW_SDK_ACTIVITIES.add(com.droi.mobileads.MraidVideoPlayerActivity.class);
        REQUIRED_WEB_VIEW_SDK_ACTIVITIES.add(com.droi.common.DroiBrowser.class);
    }
    ...
    static {
        ...
        REQUIRED_NATIVE_SDK_ACTIVITIES.add(com.droi.common.DroiBrowser.class);
    }
    ...
    private static void logMissingActivities(@NonNull final List<Class<? extends Activity>> undeclaredActivities) {
        final StringBuilder stringBuilder =
                new StringBuilder("AndroidManifest permissions for the following required Droi activities are missing:\n");
        ...
        DroiLog.w(stringBuilder.toString());
    }
    ...
    private static void logMisconfiguredActivities(@NonNull Context context,
        ...
        final StringBuilder stringBuilder =
                new StringBuilder("In AndroidManifest, the android:configChanges param is missing values for the following Droi activities:\n");
    ...
    private static void logWarningToast(@NonNull final Context context) {
        ...
        if (isDebuggable(context)) {
            final String message = "ERROR: YOUR DROI INTEGRATION IS INCOMPLETE.\n" +
