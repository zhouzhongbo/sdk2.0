...
import com.droi.common.CloseableLayout.ClosePosition;
import com.droi.common.Constants;
import com.droi.common.VisibleForTesting;
import com.droi.common.logging.DroiLog;
import com.droi.mobileads.BaseWebView;
import com.droi.mobileads.ViewGestureDetector;
import com.droi.mobileads.ViewGestureDetector.UserClickListener;
import com.droi.mobileads.resource.MraidJavascript;
import com.droi.mraid.MraidBridge.MraidWebView.OnVisibilityChangedListener;
import com.droi.mraid.MraidNativeCommandHandler.MraidCommandFailureListener;
...
public class MraidBridge {
    ...
    public void setContentHtml(@NonNull String htmlData) {
        if (mMraidWebView == null) {
            DroiLog.d("MRAID bridge called setContentHtml before WebView was attached");
            return;
        }
    ...
    public void setContentUrl(String url) {
        if (mMraidWebView == null) {
            DroiLog.d("MRAID bridge called setContentHtml while WebView was not attached");
            return;
        }
    ...
    void injectJavaScript(@NonNull String javascript) {
        if (mMraidWebView == null) {
            DroiLog.d("Attempted to inject Javascript into MRAID WebView while was not "
                    + "attached:\n\t" + javascript);
            return;
        }
        DroiLog.v("Injecting Javascript into MRAID WebView:\n\t" + javascript);
    ...
    boolean handleShouldOverrideUrl(@NonNull final String url) {
        ...
        try {
            ...
            DroiLog.w("Invalid MRAID URL: " + url);
        ...
        if (mIsClicked) {
            ...
            try {
                if (mMraidWebView == null) {
                    DroiLog.d("WebView was detached. Unable to load a URL");
                    return true;
                }
                mMraidWebView.getContext().startActivity(intent);
                return true;
            } catch (ActivityNotFoundException e) {
                DroiLog.d("No activity found to handle this URL " + url);
                return false;
            }
        }
