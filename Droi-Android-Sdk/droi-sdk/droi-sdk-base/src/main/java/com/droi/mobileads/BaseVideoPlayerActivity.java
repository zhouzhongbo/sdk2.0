...
import static com.droi.mobileads.VastVideoViewController.VAST_VIDEO_CONFIG;
...
public class BaseVideoPlayerActivity extends Activity {
    ...
    public static void startMraid(final Context context, final String videoUrl) {
        ...
        try {
            ...
            DroiLog.d("Activity MraidVideoPlayerActivity not found. Did you declare it in your AndroidManifest.xml?");
        }
    }
