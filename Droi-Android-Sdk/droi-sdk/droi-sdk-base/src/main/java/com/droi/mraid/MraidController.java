...
import com.droi.common.CloseableLayout;
import com.droi.common.CloseableLayout.ClosePosition;
import com.droi.common.CloseableLayout.OnCloseListener;
...
import com.droi.mobileads.MraidVideoPlayerActivity;
import com.droi.mobileads.util.WebViews;
import com.droi.mraid.MraidBridge.MraidBridgeListener;
import com.droi.mraid.MraidBridge.MraidWebView;
...
import static com.droi.common.util.Utils.bitMaskContainsFlag;
...
public class MraidController {
    ...
    private void setViewState(@NonNull ViewState viewState, @Nullable Runnable successRunnable) {
        ...
        DroiLog.d("MRAID state set to " + viewState);
    ...
    /**
     * Attempts to handle droinativebrowser links in the device browser, deep-links in the
     * corresponding application, and all other links in the Droi in-app browser.
     */
    @VisibleForTesting
