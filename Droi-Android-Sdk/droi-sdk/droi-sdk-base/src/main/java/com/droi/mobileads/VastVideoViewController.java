...
import com.droi.common.IntentActions;
...
import static com.droi.common.DroiBrowser.DROI_BROWSER_REQUEST_CODE;
import static com.droi.mobileads.VastXmlManagerAggregator.ADS_BY_AD_SLOT_ID;
import static com.droi.mobileads.VastXmlManagerAggregator.SOCIAL_ACTIONS_AD_SLOT_ID;
...
public class VastVideoViewController extends BaseVideoViewController {
    ...
    void onActivityResult(final int requestCode, final int resultCode, final Intent data) {
        if (requestCode == DROI_BROWSER_REQUEST_CODE && resultCode == Activity.RESULT_OK) {
    ...
    private VastWebView createCompanionVastWebView(@NonNull final Context context,
        ...
        // new urls in the Droi Browser. For static images, use the clickthrough url specified in
        ...
        companionView.setVastWebViewClickListener(new VastWebView.VastWebViewClickListener() {
            ...
            public void onVastWebViewClick() {
                ...
                vastCompanionAdConfig.handleClick(context, DROI_BROWSER_REQUEST_CODE, null, mVastVideoConfig.getDspCreativeId());
            }
        });
        companionView.setWebViewClient(new WebViewClient() {
            @Override
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                vastCompanionAdConfig.handleClick(context, DROI_BROWSER_REQUEST_CODE, url, mVastVideoConfig.getDspCreativeId());
                return true;
            }
        });
