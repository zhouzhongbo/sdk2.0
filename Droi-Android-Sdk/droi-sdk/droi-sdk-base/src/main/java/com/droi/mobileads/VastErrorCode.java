...
/**
 * The various possible error codes for VAST that Droi supports. See
...
public enum VastErrorCode {
    ...
    /**
     * For any reason the companion ad failed to download or show. Droi still tries to show the
