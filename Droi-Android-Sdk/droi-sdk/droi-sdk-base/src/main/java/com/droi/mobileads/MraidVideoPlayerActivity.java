...
import com.droi.mraid.MraidVideoViewController;

import static com.droi.common.DataKeys.BROADCAST_IDENTIFIER_KEY;
import static com.droi.mobileads.BaseBroadcastReceiver.broadcastAction;
...
public class MraidVideoPlayerActivity extends BaseVideoPlayerActivity implements BaseVideoViewController.BaseVideoViewControllerListener {
    private static final String NATIVE_VIDEO_VIEW_CONTROLLER =
            "com.droi.nativeads.NativeVideoViewController";
    ...
    public void onStartActivityForResult(final Class<? extends Activity> clazz,
        ...
        try {
            ...
            DroiLog.d("Activity " + clazz.getName() + " not found. Did you declare it in your AndroidManifest.xml?");
        }
    }
