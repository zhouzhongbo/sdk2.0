...
public abstract class DroiHttpUrlConnection extends HttpURLConnection {
    private static final int CONNECT_TIMEOUT = 10000;
    private static final int READ_TIMEOUT = 10000;

    private DroiHttpUrlConnection(URL url) {
        super(url);
    }
    ...
    static boolean isUrlImproperlyEncoded(@NonNull String url) {
        try {
            ...
            DroiLog.w("Url is improperly encoded: " + url);
            return true;
        }
        return false;
    }
    ...
    static URI encodeUrl(@NonNull String urlString) throws Exception {
        ...
        try {
            ...
            DroiLog.w("Failed to encode url: " + urlString);
            throw e;
        }
        return uri;
    }
