...
import static com.droi.common.DiskLruCache.open;
...
public class CacheService {
    ...
    static final String UNIQUE_CACHE_NAME = "droi-cache";
    ...
    public static boolean initializeDiskCache(final Context context) {
        ...
        if (sDiskLruCache == null) {
            ...
            try {
                ...
                DroiLog.d("Unable to create DiskLruCache", e);
                return false;
            }
        }
        return true;
    ...
    public static byte[] getFromDiskCache(final String key) {
        ...
        try {
            ...
            DroiLog.d("Unable to get from DiskLruCache", e);
        } finally {
            if (snapshot != null) {
                snapshot.close();
            }
    ...
    public static boolean putToDiskCache(final String key, final InputStream content) {
        ...
        try {
            ...
            DroiLog.d("Unable to put to DiskLruCache", e);
            try {
                if (editor != null) {
                    editor.abort();
                }
