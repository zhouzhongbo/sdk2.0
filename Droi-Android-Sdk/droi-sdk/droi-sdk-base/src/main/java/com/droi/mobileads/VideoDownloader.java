...
import com.droi.common.CacheService;
...
public class VideoDownloader {
    ...
    public static void cache(@Nullable final String url,
        ...
        if (url == null) {
            DroiLog.d("VideoDownloader attempted to cache video with null url.");
    ...
    static class VideoDownloaderTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected Boolean doInBackground(final String... params) {
            if (params == null || params.length == 0 || params[0] == null) {
                DroiLog.d("VideoDownloader task tried to execute null or empty url.");
                return false;
            }
            ...
            try {
                urlConnection = DroiHttpUrlConnection.getHttpUrlConnection(videoUrl);
                ...
                if (statusCode < HttpURLConnection.HTTP_OK
                    ...
                    DroiLog.d("VideoDownloader encountered unexpected statusCode: " +
                            statusCode);
                    return false;
                }
                ...
                DroiLog.d("VideoDownloader task threw an internal exception.", e);
                return false;
            } finally {
        ...
        protected void onCancelled() {
            DroiLog.d("VideoDownloader task was cancelled.");
            sDownloaderTasks.remove(mWeakSelf);
            mListener.onComplete(false);
        }
    }
