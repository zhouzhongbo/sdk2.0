        ...
        if (mForceOrientation == DeviceUtils.ForceOrientation.FORCE_PORTRAIT) {
            ...
            switch (currentOrientation) {
                ...
                case Configuration.ORIENTATION_UNDEFINED:
                    DroiLog.d("Screen orientation undefined: do not show gradient strip widget");
                    setVisibility(View.INVISIBLE);
                    break;
                case Configuration.ORIENTATION_SQUARE:
                    DroiLog.d("Screen orientation is deprecated ORIENTATION_SQUARE: do not show gradient strip widget");
                    setVisibility(View.INVISIBLE);
                    break;
                default:
                    DroiLog.d("Unrecognized screen orientation: do not show gradient strip widget");
                    setVisibility(View.INVISIBLE);
                    break;
            }
        }
