...
/**
 * Data Object for the DroiViewabilityTracker VAST Custom Extension.
 */
public class VideoViewabilityTrackerXmlManager {
    ...
    Integer getViewablePlaytimeMS() {
        ...
        if (Strings.isAbsoluteTracker(viewablePlaytimeStr)) {
            try {
                ...
                DroiLog.d(String.format("Invalid VAST viewablePlaytime format " +
    ...
    Integer getPercentViewable() {
        ...
        try {
            ...
            DroiLog.d(String.format("Invalid VAST percentViewable format for \"d{1,3}%%\": %s:",
                    percentViewableStr));
        }
