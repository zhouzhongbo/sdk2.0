...
/**
 * Keys used in localExtras and serverExtras maps for Droi custom events.
 */
public class DataKeys {
    public static final String AD_REPORT_KEY = "droi-intent-ad-report";
    ...
    public static final String CREATIVE_ORIENTATION_KEY = "com_droi_orientation";
    public static final String JSON_BODY_KEY = "com_droi_native_json";
    public static final String BROADCAST_IDENTIFIER_KEY = "broadcastIdentifier";
    public static final String AD_UNIT_ID_KEY = "com_droi_ad_unit_id";
    public static final String AD_WIDTH = "com_droi_ad_width";
    public static final String AD_HEIGHT = "com_droi_ad_height";
