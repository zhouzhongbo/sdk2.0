                ...
                .withResultActions(new UrlHandler.ResultActions() {
                    ...
                    public void urlHandlingSucceeded(@NonNull String url,
                        ...
                        if (urlAction == UrlAction.OPEN_IN_APP_BROWSER) {
                            ...
                            bundle.putString(DroiBrowser.DESTINATION_URL_KEY, url);
                            bundle.putString(DroiBrowser.DSP_CREATIVE_ID, mDspCreativeId);

                            final Class clazz = DroiBrowser.class;
                            ...
                            try {
                                ...
                                DroiLog.d("Activity " + clazz.getName() + " not found. Did you " +
    ...
    public Integer getSkipOffsetMillis(final int videoDuration) {
        if (mSkipOffset != null) {
            try {
                ...
                DroiLog.d(String.format("Failed to parse skipoffset %s", mSkipOffset));
            }
        }
        return null;
    }
