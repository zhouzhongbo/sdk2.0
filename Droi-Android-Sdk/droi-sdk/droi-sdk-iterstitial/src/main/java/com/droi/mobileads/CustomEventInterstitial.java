 ...
 * implementing subclasses of CustomEventInterstitial, you can enable the Droi SDK to natively
 * support a wider variety of third-party ad networks, or execute any of your application code on
 * demand.
 * 
 * At runtime, the Droi SDK will find and instantiate a CustomEventInterstitial subclass as needed
...
public abstract class CustomEventInterstitial {
     ...
     * your application by calling DroiInterstitial.setLocalExtras(Map<String, Object>). Note that
     ...
     * Droi website that you want to associate with a given custom event request. This data may be
    ...
    public interface CustomEventInterstitialListener {
         ...
         * stall.
         */
        void onInterstitialFailed(DroiErrorCode errorCode);
