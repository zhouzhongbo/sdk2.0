 ...
 * subclasses of CustomEventBanner, you can enable the Droi SDK to natively support a wider
 * variety of third-party ad networks, or execute any of your application code on demand.
 * 
 * At runtime, the Droi SDK will find and instantiate a CustomEventBanner subclass as needed
...
public abstract class CustomEventBanner {
     ...
     * your application by calling DroiView.setLocalExtras(Map<String, Object>). Note that the
    ...
    public interface CustomEventBannerListener {
         ...
         * stall.
         */
        void onBannerFailed(DroiErrorCode errorCode);
